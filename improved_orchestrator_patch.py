...
# Test with the actual response from your Claude
test_response = '''I'll analyze the current signup UX and create a plan to improve it. Let me first examine the existing auth components to understand the current flow and identify pain points.
{
  "decision": "EXECUTE'''

print("Testing with your actual response:")
result = improved_parse_control_protocol(test_response)
print(f"Result: {result['decision']} - {result.get('reason', 'Parsed successfully')}")
if result.get('plan'):
